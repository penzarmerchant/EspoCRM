...
export class CreateAccount extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.emailTextBox = page.locator('//input[@class="form-control email-address"]');
    this.phoneTextBox = page.locator('//input[@type="input"]');
    this.streetBillingAddTextBox = page.locator('textarea[data-name="billingAddressStreet"]');
    this.cityBillingAddTextBox = page.locator('input[data-name="billingAddressCity"]');
    this.countyBillingAddTextBox = page.locator('input[data-name="billingAddressState"]');
    ...
    this.streetShippingAddTextBox = page.locator('textarea[data-name="shippingAddressStreet"]');
    this.cityShippingAddTextBox = page.locator('input[data-name="shippingAddressCity"]');
    this.countyShippingAddTextBox = page.locator('input[data-name="shippingAddressState"]');
    this.postalCodeShippingAddTextBox = page.locator('input[data-name="shippingAddressPostalCode"]');
    this.countryShippingAddTextBox = page.locator('input[data-name="shippingAddressCountry"]');
    this.typeTextBox = page.locator('(//div[@class="selectize-control form-control main-element single plugin-espo_select"])[1]');
    this.industryTextBox = page.locator('(//div[@class="selectize-input items full has-options has-items"])[2]');
    ...
    this.citySelection=page.locator('//div[normalize-space(text())="Brighton"]')
  ...
  async enterbillingPostalCode(billingAddresspostalCode: string) {
    await this.fillField(this.postalCodeBillingAddTextBox,  billingAddresspostalCode);
  }
  ...
  async enterShippingPostalCode(shippingAddresspostalCode: string) {
    await this.fillField(this.postalCodeShippingAddTextBox,  shippingAddresspostalCode);
  }

  async enterShippingAddressCountry(shippingAddressCountry: string) {
    await this.fillField(this.countryShippingAddTextBox,shippingAddressCountry);
  }
